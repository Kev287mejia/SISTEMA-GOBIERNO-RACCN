...
export default function TesoreriaPage() {
    ...
    const handleEmitCheck = (check: any) => {
        ...
        setBankDetails({ ...bankDetails, numeroCheque: check.numero })
        setOpenDialog(true)
    }
        ...
        <DashboardLayout>
            <div className="min-h-screen bg-[#fcfcfc] pb-20">
                <ModuleHero 
                    ...
                    subtitle="GESTIÓN DE EMISIÓN, ENTREGA DE CHEQUES Y CONTROL DE PAGOS"
                />

                <div className="max-w-7xl mx-auto px-8 -mt-20 relative z-30 space-y-8">
                    <div className="flex justify-end mb-4">
                        <Button variant="outline" onClick={fetchRequests} disabled={loading} className="bg-white/90 backdrop-blur-md shadow-lg rounded-full px-8">
